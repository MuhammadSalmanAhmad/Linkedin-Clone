...
export default function Login() {
    ...
    function showInput(event) {
        ...
        alert("Your fullname  is = " + fullname + 'your email is :'+ email+"your password is  : "+password); // Corrected this line
    }
        ...
        <div className="LoginBody">
            ...
            <div className="LoginElements">
                ...
                <TextField 
                    ...
                    sx={{ marginBottom: 3 }} 
                    value={fullname} 
                    onChange={(e) => setInput(e.target.value)} // Set the input state on change
                />
                  <TextField 
                    id="outlined-basic" 
                    label="Email" 
                    ...
                    sx={{ marginBottom: 3 }} 
                    value={email} 
                    onChange={(e) => setEmail(e.target.value)} // Set the input state on change
                />
                  <TextField 
                    id="outlined-basic" 
                    label="Password" 
...
/*
<TextField error id="outlined-basic" label="Full Name" variant="outlined" sx={{marginTop:3,marginBottom:3}}/>
        <TextField id="outlined-basic" label="Email" variant="outlined"  sx={{marginBottom:3}}/>
        <TextField id="outlined-basic" label="Password" variant="outlined"  sx={{marginBottom:3}} value={input} onChange={(e)=>{SetInput(e.target.value)}} />
